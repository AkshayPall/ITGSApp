...
public class MainActivity
    ...
    private String mApplicationID = "rTri7QJ6iN2uiL45LdS2im9ox2kMY1BJRBBRET8x";
    private String mClientKey = "t1vVIFA4WwsjxBLYje3ldEFtCluCDKkfdLH1ojPO";
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(final List<ParseObject> parseObjects, ParseException e) {
                if (e == null) {
                    ...
                    mSEIListview = (ListView) findViewById(R.id.sei_list);
